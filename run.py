...
twitch_miner = TwitchChannelPointsMiner(
    username=os.getenv("user") or "your-username-here",
    password=os.getenv("passw")
    or "write-your-secure-psw",  # If no password will be provided, the script will ask interactively
...
twitch_miner_channels: list[Streamer] = []

for streamer in streamers:
    twitch_miner_channels.append(
        Streamer(
            streamer,
